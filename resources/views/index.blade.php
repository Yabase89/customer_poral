            ...
            <div class="container-login100" style="background-image: url('{{asset('images/bg-01.jpg')}}');">
                <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                    ...
                    <div class="container-login100-form-btn customer_signup">
                            <div class="wrap-login100-form-btn">
                                <div class="login100-form-bgbtn"></div>
                                <a href="{{url('customer-signup')}}" class="newbutton"><button class="login100-form-btn">
                                    Customer Signup
                                </button>
                               </a>
                            </div>
                    </div>
                    <div class="container-login100-form-btn admin_signup">
                            <div class="wrap-login100-form-btn">
                                <div class="login100-form-bgbtn"></div>
                                <a href="{{url('admin-signup')}}" class="newbutton"><button class="login100-form-btn">
                                    Admin Signup
                                </button>
                                </a>
                            </div>
